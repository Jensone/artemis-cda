            ...
            <div class="flex items-center justify-between border-t border-gray-50 pt-4">
                <?php 
                    if ($loan['LoanStatus'] == 0) {
                        echo '<a href="edit.php?id=' . $loan['LoanId'] . '&type=loan&action=returned" class="py-2 px-3 bg-indigo-500 hover:bg-indigo-600 rounded text-xs text-white transition duration-200">Rendre</a>';
                    } else {
